 ...
 * @author Daniel Dyer
 */
public class IsNotEqual extends BinaryNode
{
    /**
     ...
     */
    public IsNotEqual(Node left, Node right)
    {
        super(left, right, "!=");
    }
    ...
    public Node simplify()
    {
        ...
        {
            return new IsNotEqual(simplifiedLeft, simplifiedRight);
        }
        else
        {
            return this;

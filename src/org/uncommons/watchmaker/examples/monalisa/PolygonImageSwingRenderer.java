...
public class PolygonImageSwingRenderer implements Renderer<List<ColouredPolygon>, JComponent>
{
    ...
    public PolygonImageSwingRenderer(BufferedImage targetImage)
    {
        ...
        Image temp = targetImage.getScaledInstance(this.WIDTH, this.HEIGHT, Image.SCALE_FAST);
        
    	this.targetImage = new BufferedImage(this.WIDTH,
                                             this.HEIGHT,
                                             BufferedImage.TYPE_INT_RGB);
        this.targetImage.getGraphics().drawImage(temp, 0, 0, null);
    ...
    private final class ImageComponent extends JComponent
    {
        ...
        protected void paintComponent(Graphics graphics)
        {
            ...
            Graphics2D clip = (Graphics2D) graphics.create(x + targetImage.getWidth() + GAP,
                                            y,
                                            400,
                                            400 + FOOTER);
            clip.drawImage(candidateImage, 0, 0, 400, 400, 0, 0, candidateImage.getWidth(), candidateImage.getHeight(), this);
